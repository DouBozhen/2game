...
{
    processCmd(CloseRobot);
}


bool TestTcpComm::testSetForceLevel(int level)
{
    processSetCmd(TractionForce_SetLevel, level);
}

bool TestTcpComm::testGetForceLevel()
{
    int speed_ratio;
    processGetCmd(TractionForce_GetLevel, speed_ratio);
}

bool TestTcpComm::testSetRepeatedCount(int count)
{
    processSetCmd(TrajectoryReconstruction_SetRepeatCount, count);
}

bool TestTcpComm::testGetRepeatedCount()
{
    int speed_ratio;
    processGetCmd(TrajectoryReconstruction_GetRepeatCount, speed_ratio);
}

bool TestTcpComm::testSetSpeedRatio(int ratio)
{
    processSetCmd(TrajectoryReconstruction_SetSpeedRatio, ratio);
}

bool TestTcpComm::testGetSpeedRatio()
{
    int speed_ratio;
    processGetCmd(TrajectoryReconstruction_GetSpeedRatio, speed_ratio);
}

bool TestTcpComm::testOpenTrajRecurr()
{
    processCmd(TrajectoryReconstruction_Open);
}

bool TestTcpComm::testCloseTrajRecurr()
{
    processCmd(TrajectoryReconstruction_Close);
}

bool TestTcpComm::testStartTrajRecurr()
{
    processCmd(TrajectoryReconstruction_Start);
}

bool TestTcpComm::testStopTrajRecurr()
{
    processCmd(TrajectoryReconstruction_End);
}
